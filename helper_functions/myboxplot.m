function h=myboxplot(type,varargin)
...
if strcmp(type,'fill')
    ...
    for jj = 1:numel(gPos)
        [Xx,Yy] = meshgrid([gPos(jj)-gWidth(jj)/2 gPos(jj)+gWidth(jj)/2], [boxValPlot.q1(jj) boxValPlot.q3(jj)-boxValPlot.q1(jj)]);
        gFill=area(Xx', Yy'); hold on;
        set(gFill(1),'FaceColor', 'none', 'EdgeColor', 'none')  %make lower area-plot invisible
        set(gFill(2),'FaceColor', cfill(jj,:), 'EdgeColor', 'none')   %colour for main error fill-in
        %alpha(gFill(2),0.9)
    end
end
    ...
    case 'outline',
        ...
        hwhisker = ...
            ...
            'lineAlongResponse',{...
                ...
                'locationend',boxValPlot.whi,...
                'linestyle','--','linewidth',1,'linecolor',cWhisker,...
                'tag','Upper Whisker'},...
            'lineAlongResponse',{...
                'locationstart',boxValPlot.wlo,...
    ...
    case 'line',
        hmedian = ...
            ...
            'lineAlongFactor',{'location',boxValPlot.q2,...
                ...
                'linestyle','-','linewidth',1,'linecolor',cMedian,...
                'tag','Median'}...
            );
    otherwise
        error(message('stats:boxplot:BadMedianStyle'));
